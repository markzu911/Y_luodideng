...
Return only the raw JSON. Do not wrap it in markdown code blocks like \`\`\`json.`,
        ...
        if (safeParams.viewType === "far") {
          preservationGuidance = "2. FULL-HEIGHT CORNER SHOT (远景/全景视角): Frame the full floor lamp standing snugly in the corner right beside the sofa or bed. The sofa armrest/cushions and corner wall must encompass the lamp in a natural, cohesive interior perspective.";
          perspectiveGuidance = "4. VIEW AND PERSPECTIVE (FAR VIEW / 远景/全景视角): Wide-to-medium interior framing showing the full height of the floor lamp tucked right beside the sofa armrest or bed in the room corner.";
          ...
          preservationGuidance = "2. CLOSE-UP DETAIL SHOT WITH NATURAL SOFA PROXIMITY (近景/特写视角 - 落地灯紧贴沙发扶手/侧边与自然透视):\n   - CAMERA DISTANCE & PERSPECTIVE: Close-up detail shot framing the glowing lampshade and upper pole of the floor lamp, AND capturing the top of the adjacent sofa armrest or side table right next to it in realistic close perspective.\n   - STRICT SPATIAL PROXIMITY (严禁置于房间中央!): The floor lamp MUST NOT stand isolated in open space or in the middle of the room! The sofa armrest, cushions, or side table decor MUST be right beside the lamp pole in the frame, clearly showing the lamp is standing right next to the sofa.\n   - CROP LEVEL: Zoomed in close on the upper portion of the floor lamp and the adjacent sofa armrest/wall section. Lower pole base and floor are cropped out naturally by the camera proximity.\n   - REAL ROOM BACKGROUND: The background MUST strictly be an authentic section of the room from IMAGE 1 (textured wall, sofa armrest, curtains) directly behind and beside the lamp.";
          perspectiveGuidance = "4. VIEW AND PERSPECTIVE (MACRO CLOSE-UP VIEW / 近景特写视角): Camera zoomed in close to the glowing lampshade and upper pole, with the sofa armrest/side table right alongside the lamp pole to establish realistic close-up room perspective.";
        }
...
4. STRICT LAMP PLACEMENT RULES & REALISTIC SPATIAL PERSPECTIVE (落地灯摆放位置与透视空间关系):
   - CRITICAL SOFA PLACEMENT & PHYSICAL PROXIMITY: The floor lamp MUST be placed directly beside the sofa armrest or in the corner wall right behind the armrest. The lamp pole MUST be physically close to the sofa armrest with ZERO floating gap. STRICTLY FORBIDDEN: DO NOT place the floor lamp isolated in the middle of the room, in open pathways, or in front of the sofa! (绝对禁止将落地灯孤立放置在房间中央空地或离沙发太远的空旷处！必须紧贴沙发扶手或墙角放置！).
   ...
   - PERSPECTIVE ALIGNMENT: In all camera angles (including close-up), the sofa armrest, headboard, or side table MUST be directly adjacent to the lamp pole in the camera view to establish a natural, physically realistic spatial perspective.
