...
Return only the raw JSON. Do not wrap it in markdown code blocks like \`\`\`json.`,
        ...
        const STYLE_SPECS: Record<string, string> = {
          "极简风": "MASTERPIECE ARCHITECTURE: Ultra-high-end elegant minimalist bedroom (极简风卧室). Warm, quiet, luxury atmosphere. MATERIALS: Seamless matte charcoal black headboard wall panels, high-end natural dark micro-cement or plaster, sheer white translucent linen curtains, dark gray drapery, textured gray wool rug. LIGHTING: Built-in ambient linear LED yellow glow backlight behind the headboard panel, warm cove ceiling lighting casting a soft wash downward, and a slender black geometric pendant light hanging low on the side. FURNITURE: A very low-profile modern platform bed with a wide dark-gray/black textured fabric frame, gray duvet bedding, and plush white pillows. Large floor-to-ceiling glass window with black frames showing distant view. VIBE: Serene, silent, incredibly peaceful, ultra-luxurious minimalist, photorealistic 8k.",
