...
- Colors: ${roomAnalysis.colors.join(", ")}`
          : `CRITICAL ROOM PRESERVATION RULES (真实照片背景、家具硬装与布局100%严苛保持一致 - 绝不修改或虚构背景):
