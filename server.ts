...
Return only the raw JSON. Do not wrap it in markdown code blocks like \`\`\`json.`,
        ...
        const STYLE_SPECS: Record<string, string> = {
          ...
          "新中式": "ARCHITECTURAL STYLE: High-End New Chinese (Oriental Aesthetics x Modern Minimalism). Features large floor-to-ceiling windows with abundant natural light. Walls are warm rice-white plaster. Include a natural wood slatted (格栅) background wall and dark walnut furniture. Sofa should be minimalist Chinese style with elegant fabric cushions. Details: Round tea table, celadon tea sets, landscape paintings (山水画), and Zen ornaments. Flooring: High-quality natural stone. Lighting: Warm, layered ambient glow. Atmosphere: Tranquil, elegant, and rich in spatial hierarchy. Professional magazine-level interior photography with realistic textures.",
