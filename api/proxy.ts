...
Return only the raw JSON. Do not wrap it in markdown code blocks like \`\`\`json.`,
        ...
        if (params.viewType === "far") {
          ...
          preservationGuidance = "2. CLOSE-UP SHOT DESIGN & PERSPECTIVE (近景/灯罩特写/直视视角): Straight frontal eye-level macro close-up. The camera is leveled directly near the lower rim of the lampshade, capturing a perfectly straight and horizontal lower edge of the shade (镜头的视平线高度刚好平视灯罩的下沿，使得下沿在画面中呈现为一条完全水平的直线，不能有仰角 or 俯角的弧度). The lampshade MUST dominate 60%-70% of the entire frame horizontally and vertically, positioned in the upper-center of the image (灯罩在画面中上部占据60%-70%的绝对主体地位). Extending from the lampshade is the pole or neck structure of the floor lamp, which MUST strictly preserve the exact shape, curvature, and physical structure of the user's uploaded floor lamp reference (灯罩下方延伸出的灯杆/支架结构，必须高度还原用户上传落地灯参考图中的材质、金属色泽与物理弯曲度/直立特征。如果参考图是直杆则保持笔直；如果是拱形弧度或带弯曲度，则必须保留其物理弯曲或支撑结构，绝不强求一律笔直，必须要与用户上传的原图极高一致). If the original lamp has a delicate golden beaded pull-chain switch hanging straight down from inside the lampshade, preserve it parallel next to the pole; otherwise, respect the original lamp's components. In the lower-left corner of the frame, a simple round white ceramic flower vase with blooming soft pink roses rests on a table surface covered with a delicate white lace-trimmed table runner / tablecloth (画面左下角，一张铺有白色精致蕾丝边桌布的桌面上，摆放着一个圆形白色陶瓷花瓶，瓶中插着几朵娇艳盛开的淡粉色玫瑰花). The background is a dim, clean, and out-of-focus dark-grey or deep-brown flat paneled wall/cabinet door, creating a sophisticated luxury contrast (背景为暗色调、虚化、平整的暗灰色或深褐色木饰面墙板/柜门，烘托出高级温馨的对比氛围). The floor, lamp base, room ceiling, and rest of the furniture are completely cropped out of the frame (地、灯座、天花板以及完整的家具主体均被完全裁剪在画面之外).";
          perspectiveGuidance = "4. VIEW AND PERSPECTIVE (CLOSE VIEW / 近景/灯罩平视特写): A perfectly leveled, frontal, straight-on macro-shot. The camera lens is positioned directly level with the lower edge of the lampshade. The lampshade dominates the top-center of the screen. Directly below the shade, the physical support pole or neck structure (e.g., straight, arched, or curved) must perfectly replicate the shape, metallic finish, and texture of the original uploaded reference floor lamp. Parallel to it, replicate any pull-chain details if they exist in the original. In the bottom-left corner, frame the top of a table with a white lace runner and a round white vase containing pink roses. The background must be a dark, simple flat panel, completely sharp-focus on the lamp and softly focused on the vase. Absolutely NO generic horizontal brackets, swing arms, or side attachments around the shade unless they exist on the original uploaded lamp!";
        }
